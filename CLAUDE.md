...
- **Enforcement, both ways:** if easy runs cluster above the ceiling, call it out
  by name, with exact bpm and the corrected distribution. If they're genuinely
  easy, **say so plainly and credit the discipline.**
...
- **RED, BACK OFF NOW** (real pain, not DOMS, or illness, or 2+ missed days):
...
something genuinely working, and find it in the data.
